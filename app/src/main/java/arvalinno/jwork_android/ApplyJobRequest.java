...
public class ApplyJobRequest extends StringRequest {
    private static final String URL_Ewallet = "http://192.168.100.24:8080/invoice/createEWalletPayment";
    private static final String URL_Bank = "http://192.168.100.24:8080/invoice/createBankPayment";
