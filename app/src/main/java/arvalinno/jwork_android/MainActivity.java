    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener(){
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int j, long l) {
                Intent intent = new Intent(arvalinno.jwork_android.MainActivity.this, ApplyJobActivity.class);
                int jobId = childMapping.get(listRecruiter.get(i)).get(j).getId();
                String jobName = childMapping.get(listRecruiter.get(i)).get(j).getName();
                String jobCategory = childMapping.get(listRecruiter.get(i)).get(j).getCategory();
                int jobFee = childMapping.get(listRecruiter.get(i)).get(j).getFee();
